document.addEventListener('DOMContentLoaded', () => {
    ...
    const handleRegister = async () => {
        ...
        window.location.href = `/setup.html?username=${encodeURIComponent(username)}&password=${encodeURIComponent(password)}&editorPassword=${encodeURIComponent(editorPassword)}`;
    };
